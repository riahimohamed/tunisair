...
require_once 'addChart.php';

$resutl = $con->query('SELECT * FROM chart');
        ...
        <div class="col-sm-10 col-sm-offset-1">
            ...
            if($resutl) {
                if (mysqli_num_rows($resutl) > 0) {
                            ...
                            if(isset($_SESSION['role'])) {
                                if ($_SESSION['role'] == 'admin') {
                                    ...
                                    <div class="param">
                                        <ul>
                                            <li title="modifier">
                                                <a href="edit.php?edit_id=<?php echo $row['id'];?>"><h4><i class="glyphicon glyphicon-edit"></i></h4></a>
                                            </li>
                                            <li title="modifier">
                                                <a href="index.php?del_id=<?php echo $row['id'];?>"><h4 class="text-danger"><i class="glyphicon glyphicon-remove"></i></h4></a>
                                            </li>
                                        </ul>
                                    </div>
                                <?php
                    ...
                    echo "<h2 class='col-sm-4 col-sm-offset-4 text-info text-center'>Aucun Chart de sécurité</h2>";
                }
            }
            ?>
        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4>Ajouter chart de sécurité</h4>
                </div>
                <div class="modal-body">
                    <form class="form-horizontal" action="<?php $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data"  role="form">
                        ...
                        <div class="pull-right">
                            <button type="submit" name="submitchart" class="btn btn-primary">Enregistrer</button>
                        </div>
                        <br>
                        <br>
                    </form>
