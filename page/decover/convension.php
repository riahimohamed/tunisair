...
require_once 'addConv.php';

$resutl = $con->query('SELECT * FROM convension');
        ...
        <div class="col-sm-10 col-sm-offset-1">
            ...
            if($resutl) {
                if (mysqli_num_rows($resutl) > 0) {
                            ...
                            if(isset($_SESSION['role'])) {
                                if ($_SESSION['role'] == 'admin') {
                                    ...
                                    <div class="param">
                                        <ul>
                                            <li title="modifier">
                                                <a href="convension/edit.php?edit_id=<?php echo $row['id'];?>"><h4><i class="glyphicon glyphicon-edit"></i></h4></a>
                                            </li>
                                            <li title="modifier">
                                                <a href="convension.php?del_id=<?php echo $row['id'];?>"><h4 class="text-danger"><i class="glyphicon glyphicon-remove"></i></h4></a>
                                            </li>
                                        </ul>
                                    </div>
                                <?php
                    ...
                    echo "<h2 class='col-sm-4 col-sm-offset-4 text-info text-center'>Aucune convension</h2>";
                }
            }
            ?>
        </div>
                ...
                <div class="modal-body">
                    <form class="form-horizontal" action="<?php $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data"  role="form">
                        ...
                        <div class="pull-right">
                            <button type="submit" name="submitConv" class="btn btn-primary">Enregistrer</button>
                        </div>
                        <br>
                        <br>
                    </form>
