...
$resutl = $con->query("SELECT * FROM convension WHERE id = '$edit_id' ");
...
if(isset($_POST['edithtc'])) {
    ...
    $edit= $con->query("UPDATE convension SET title='$title', htext='$htext' WHERE id='$id'");
...
?>
    ...
    <section class="convesion">
        <div class="row">

            <div class="pull-right"><a href="../convension.php"><h3><i class="glyphicon glyphicon-arrow-left"></i></h3></a></div>

            <div class="col-sm-10 col-sm-offset-1">
                <h1>Modifier Convension</h1>
