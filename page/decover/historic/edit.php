...
$resutl = $con->query("SELECT * FROM historic WHERE id = '$edit_id' ");

if(isset($_POST['edithtc'])) {
    $title = $_POST['title'];
    $htext = $_POST['htext'];

    $edit= $con->query("UPDATE historic SET title='$title', htext='$htext' WHERE id='$edit_id'");
...
?>
    ...
    <section class="historic">
        <div class="row">
            ...
            <div class="pull-right"><a href="../historic.php"><h3><i class="glyphicon glyphicon-arrow-left"></i></h3></a></div>
